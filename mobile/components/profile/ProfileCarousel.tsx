...
const PrimeButtonSvg = () => (
  <Svg width="115" height="32" viewBox="0 0 115 32" fill="none">
    ...
    <Defs>
      <SvgLinearGradient id="paint0_linear_255_1284" x1="92.3751" y1="-1.59355e-06" x2="85.4533" y2="38.5756" gradientUnits="userSpaceOnUse">
      ...
      <SvgLinearGradient id="paint1_linear_255_1284" x1="82.7507" y1="8" x2="80.4224" y2="27.6327" gradientUnits="userSpaceOnUse">
        <Stop stopColor="#CF69C1"/>
        <Stop offset="0.163487" stopColor="#0CF5FF"/>
        <Stop offset="0.53849" stopColor="#EB926C"/>
        <Stop offset="1" stopColor="#D25FEE"/>
...
export function ProfileCarousel({ name, age, emoji, bio, avatarUrl, isPremium, plansCount }: ProfileCarouselProps) {
  const safePlans = plansCount ?? 0;
  const hasPlans = safePlans > 0;

  return (
    <View style={styles.cardContent}>
      <View style={styles.headerRow}>
        <Image 
          source={avatarUrl ? { uri: avatarUrl } : require('@/assets/images/img.png')} 
      ...
      <View style={styles.infoContainer}>
        <View style={styles.nameRow}>
          <Text style={styles.name}>{name || 'User'}, {age || '??'}</Text>
          <Text style={styles.beerIcon}>{emoji || '👋'}</Text>
        </View>
      ...
      <View style={styles.footerRow}>
        <View style={[styles.activePlansContainer, !hasPlans && styles.activePlansContainerEmpty]}>
          <View style={styles.activePlans}>
            <View style={[styles.dot, !hasPlans && styles.dotEmpty]} />
            <Text style={[styles.activePlansText, !hasPlans && styles.activePlansTextEmpty]}>
              {safePlans} active plans
            </Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  divider: {
    height: 1,
    width: '100%',
    backgroundColor: 'rgba(79, 137, 255, 0.15)',
    marginBottom: 20,
  },
  footerRow: {
    flexDirection: 'row',
  ...
  activePlansContainer: {
    ...
    backgroundColor: 'rgba(79, 137, 255, 0.08)',
  },
  activePlansContainerEmpty: {
